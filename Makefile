...
venv:
	...
	pip3 install wheel && \
	pip3 install isort ansible-lint==6.14.4 yamllint ansible==7.4.0
...
clean:
	...
	-rm -rf tests/playbooks/xsrv-test/ansible_collections/ tests/playbooks/xsrv-test/.venv/ tests/playbooks/xsrv-test/data/cache/facts/ tests/playbooks/xsrv-test/data/public_keys/root@my.example.test.pub tests/playbooks/xsrv-test/data/certificates/
