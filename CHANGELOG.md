...
#### [v1.20.0](https://gitlab.com/nodiscc/xsrv/-/releases#1.20.0) - UNRELEASED
...
**Changed:**
- xsrv: init-vm-template: use the gateway IP address as DNS nameserver by default instead of cloudflare public DNS
