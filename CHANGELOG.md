...
* nextcloud,openldap,shaarli,tt-rss: remove stale php8.2 FPM pool definitions on Debian 13 hosts
...
* shaarli: update to v0.16.5 [[1](https://github.com/shaarli/Shaarli/releases/tag/v0.16.5)
