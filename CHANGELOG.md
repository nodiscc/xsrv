...
- postgresql: update pgmetrics to v1.19.0 [[1]](https://github.com/rapidloop/pgmetrics/releases/tag/v1.17.1) [[2]](https://github.com/rapidloop/pgmetrics/releases/tag/v1.18.0) [[3]](https://github.com/rapidloop/pgmetrics/releases/tag/v1.19.0)
- stirlingpdf: update to [v2.5.3](https://github.com/Stirling-Tools/Stirling-PDF/releases)
...
- matrix: update element-web to [v1.12.11](https://github.com/element-hq/element-web/releases/)
...
- xsrv: update trivy security scanner to [v0.69.1](https://github.com/aquasecurity/trivy/releases)
