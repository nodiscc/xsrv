...
- netdata: [`netdata_notification_downtimes`](https://gitlab.com/nodiscc/xsrv/-/blob/master/roles/monitoring_netdata/defaults/main.yml): allow disabling alerts completely instead of just silencing notifications
