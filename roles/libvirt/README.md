...
[![](https://github.com/nodiscc/toolbox/raw/master/DOC/SCREENSHOTS/KLtl38W.png)](https://github.com/nodiscc/toolbox/raw/master/DOC/SCREENSHOTS/AbZkpvF.png)
[![](https://github.com/nodiscc/toolbox/raw/master/DOC/SCREENSHOTS/aZ6rtn3.png)](https://github.com/nodiscc/toolbox/raw/master/DOC/SCREENSHOTS/XNCGMBr.png)
...
This role will not implement wrappers for all features of libvirt - notably, you should use [`virsh`](https://manpages.debian.org/trixie/libvirt-clients/virsh.1.en.html) directly to edit VM XML definitions to add/remove hardware, change boot options, etc. See also The page about [libvirt/virt-manager](https://xsrv.readthedocs.io/en/latest/appendices/virt-manager.html).
