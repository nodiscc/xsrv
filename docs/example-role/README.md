...
- [ ] Add the role to the [test playbook](../../tests/playbooks/xsrv-test/playbook.yml) and its [host_vars](../../tests/playbooks/xsrv-test/host_vars/my.example.test)
- [ ] Add the role to the [default xsrv playbook](../../playbooks/xsrv/playbook.yml)
- [ ] Add integration with the [homepage](../../roles/homepage) role if needed
- [ ] Add integration with the [readme_gen](../../roles/readme_gen) role if needed
- [ ] Add required role variables to the default [host_vars](../../playbooks/xsrv/host_vars/my.example.org/my.example.org.yml) file and [vaulted host_vars file](../../playbooks/xsrv/host_vars/my.example.org/my.example.org.vault.yml)
- [ ] Add screenshots (57px high) to main [README.md](../../README.md) if needed
- [ ] Add DNS records to the [server preparation documentation](../../docs/installation/server-preparation.md) if needed
- [ ] `make doc_md`
- [ ] Update `CHANGELOG.md`
